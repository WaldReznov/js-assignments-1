...
function getAngleBetweenVectors(x1, y1, x2, y2) {
    let rad = Math.atan2(y2 - y1, x2 - x1); // In radians
...
function toNumber(value, def) {
    ...
    else if(typeof value == "string" && !isNaN(parseFloat(value))) return parseFloat(value);
    else if(typeof value == "object" && value.__proto__ == String.prototype && !isNaN(parseFloat(value))) return parseFloat(value);
    else if(typeof value == "object" && value.__proto__ == Number.prototype) return parseFloat(value);
    return def;
}
